{{-- resources/views/portfolios/sections/experiences/create.blade.php --}}
@extends('layouts.app')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="mb-0">Add Work Experience</h4>
                    <a href="{{ route('portfolios.show', $portfolio) }}" class="btn btn-sm btn-outline-secondary">
                        <i class="fas fa-arrow-left"></i> Back to Portfolio
                    </a>
                </div>
                <div class="card-body">
                    <form action="{{ route('portfolios.experiences.store', $portfolio) }}" method="POST">
                        @csrf
